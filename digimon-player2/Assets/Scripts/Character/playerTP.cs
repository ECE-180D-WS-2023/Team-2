...
public class playerTP : MonoBehaviour
{
    ...
    {
        if (e.Topic == "Team-2/Digimon/players/player2/multi")
        {
        ...
        if (connected)
        {
            if (e.Topic == "Team-2/Digimon/players/player1/x_pos")
            {
                x_pos = float.Parse(System.Text.Encoding.UTF8.GetString(e.Message));
            }
            if (e.Topic == "Team-2/Digimon/players/player1/y_pos")
            {
                y_pos = float.Parse(System.Text.Encoding.UTF8.GetString(e.Message));
            }
            if (e.Topic == "Team-2/Digimon/players/player1/looking")
            {
