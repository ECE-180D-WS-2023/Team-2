...
public class PlayerController : MonoBehaviour
{
    ...
    public void HandleUpdate()
    {
        ...
        if (multiplayerWorld)
        {
            client.Publish("Team-2/Digimon/players/player2/multi", System.Text.Encoding.UTF8.GetBytes("connected"));
            new WaitForSeconds(0.1f);
        }
        else
        {
            client.Publish("Team-2/Digimon/players/player2/multi", System.Text.Encoding.UTF8.GetBytes("disconnected"));
            new WaitForSeconds(0.1f);
        }
